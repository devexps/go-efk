module github.com/devexps/go-efk/pkg

go 1.18

replace github.com/devexps/go-efk/api => ../api

require (
	github.com/devexps/go-efk/api v0.0.0-00010101000000-000000000000
	github.com/devexps/go-micro/log/fluent/v2 v2.0.0-20230905124121-099b6ff4fe76
